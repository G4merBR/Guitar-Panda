...
enum class ElementType {
  ...
  DLATCH, JKLATCH, DFLIPFLOP, JKFLIPFLOP, SRFLIPFLOP, TFLIPFLOP, TLATCH, BOX, NODE, MUX, DEMUX,BEEP
};
...
public:
  ...
  virtual void setTone( QString getTone );
  virtual QString getTone( );
...
protected:
  ...
  void setHasTones( bool hasTones );
